...
# Function to predict class of the audio data
...
try:
    ...
    with sd.InputStream(callback=audio_callback, channels=1, samplerate=sample_rate):
        ...
        while True:
            ...
            df.loc[0] = [f"{prob * 100:.2f}%" for prob in probabilities]
            # Clear the console and print the updated table
            print("\033c", end="")  # Clear the console (for Unix-based systems)
            print(df)
